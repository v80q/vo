...
<div class="s w100 pa">
	<div class="p dib taz">
		...
		<? } ?>
		<h2 id="seo" class="gray w80 fs12 mob p30">
			Представляем вам интеллектуальную игру онлайн без  регистрации. Здесь  вы найдете много интересного: научные факты, головоломки,  логические загадки и сложные вопросы с подвохом. На нашем сайте вы можете обнаружить и шуточные, провокационные задания. На каждый каверзный вопрос даны четыре варианта ответа, из которых требуется выбрать лишь один, правильный.
   Задать свои вопросы и проверить чужие ответы может любой участник!
		</h2>
		<div class="dib w80 p10 fs20 fwb mob">
...
<nav itemscope itemtype="http://www.schema.org/SiteNavigationElement" id="page-menu" class="ht mob w100 pa" role="navigation" >
...
<div class="hb mob pa">
	<div class="copyright">
		...
		<a class="map cur tdn fwb gray" title="Карта сайта" href="/Карта_сайта">Карта сайта</a>
	</div>
